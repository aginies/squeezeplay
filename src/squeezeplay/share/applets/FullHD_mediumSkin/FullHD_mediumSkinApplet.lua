...
This applet implements a small print skin for 1920x1080 resolution
...
--	Framework:setVideoMode(1280, 800, 0, false)
...
--------- ICONBAR ---------
	...
	s.nowplaying = _uses(s.window, {
		...
		npartistgroup = {
			...
			border     = _tracklayout.border,
			x          = _tracklayout.x,
			y          = TITLE_HEIGHT + 100 + 32 + 50 + 42 + 100,
			h          = 36,
			npartist = {
				padding    = { 0, 6, 0, 0 },
				w          = screenWidth - _tracklayout.x - 10,
		...
		npalbumgroup = {
			...
			border     = _tracklayout.border,
			x          = _tracklayout.x,
			y          = TITLE_HEIGHT + 100 + 32 + 32 + 42 + 90 + 100,
			h          = 36,
			npalbum = {
				w          = screenWidth - _tracklayout.x - 10,
				padding    = { 0, 6, 0, 0 },
