...
This applet implements a small print skin for 1366x768 resolution
Based on WQVGAsmallSkin from FAB4
...
local imgpath = "applets/FullHD_mediumSkin/images/"
...
function param(self)
		...
		NOWPLAYING_TRACKINFO_LINES = 5,
		POPUP_THUMB_SIZE = 500,
		radialClock = {
			hourTickPath     = 'applets/FullHD_mediumSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/FullHD_mediumSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
--	Framework:setVideoMode(1920, 1080, 0, true)
	Framework:setVideoMode(1366, 768, 0, true)
	...
	local TEXTAREA_PADDING = { 13, 10, 8, 0 }
	...
	local ALBUMMENU_FONT_SIZE = 24
	local ALBUMMENU_SMALL_FONT_SIZE = 22
	...
	local THREE_ITEM_HEIGHT = 80
	local FIVE_ITEM_HEIGHT = 85
	local TITLE_BUTTON_WIDTH = 80
...
--------- ICONBAR ---------
	...
	local NP_ARTISTALBUM_FONT_SIZE = 45
	local NP_TRACK_FONT_SIZE = 34

	local controlHeight = 73
	local controlWidth = 135
	...
	local _tracklayout = {
		...
		w = WH_FILL,
		align = "center",
		lineHeight = 160, --NP_TRACK_FONT_SIZE,
		fg = TEXT_COLOR,
		x = 518,
	}
	...
	s.nowplaying = _uses(s.window, {
		...
		npalbumgroup = {
			...
			border     = _tracklayout.border,
			x          = _tracklayout.x,
			y          = TITLE_HEIGHT + 100 + 32 + 32 + 42 + 90,
			h          = 36,
			npalbum = {
				w          = screenWidth - _tracklayout.x - 10,
				padding    = { 0, 6, 0, 0 },
		...
		npcontrols = {
			order = { 'rew', 'div1', 'play', 'div2', 'fwd', 'div3', 'repeatMode', 'div4', 'shuffleMode',
					'div5', },
--			REMOVE VOLUME (UNWATED IN MY CASE)
--					'div5', 'volDown', 'div6', 'volSlider', 'div7', 'volUp' },
		...
		npprogress = {
			x = 562,
			position = LAYOUT_NONE,
			y = TITLE_HEIGHT + 100 + 29 + 26 + 32 + 32 + 23 + 100 + 100,
			padding = { 0, 10, 0, 0 },
		...
		npprogressNB = {
			...
			position = LAYOUT_NONE,
			x = 762,
			y = TITLE_HEIGHT + 29 + 26 + 32 + 32 + 23 + 100 + 32 + 100 + 100,
			elapsed = {
				w = WH_FILL,
				align = "left",
				font = _boldfont(18),
